<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Habitacion.aspx.cs" Inherits="ExamenFinalHospital.PaginasAdmin.Habitacion" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="text-center text-primary">Ingresar habitaciones</h1>
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4  text-start mt-2">
                <asp:TextBox ID="TextBoxHabitacion" CssClass="form-control text-primary fs-5 " Width="95%" placeholder="Urgencias" runat="server"></asp:TextBox>
            </div>
        </div>
        <div class="row">
